...
const CreatePost = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-white">
      <div className="bg-white p-8 shadow-xl w-full max-w-xl">
        ...
        <div className="relative mb-4">
          ...
          />
          <label
            className={`absolute left-0 top-2 text-gray-500 text-sm transition-all pointer-events-none ${
              formData.title
                ? "text-blue-500 -top-3.5"
        ...
        <div className="relative mb-6">
          <input
            ...
            onChange={handleChange}
            className={`peer h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-500 bg-transparent ${
              formData.image ? "py-6" : ""
            }`}
            placeholder=" "
          />
        ...
        <div className="relative mb-4">
          <textarea
            ...
            onChange={handleChange}
            required
            className={`peer h-32 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-500 bg-transparent ${
